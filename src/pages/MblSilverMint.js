...
import { connect } from "../redux/blockchain/blockchainActionsSilver";
...
function MblSilverMint() {
  ...
  const [CONFIG, SET_CONFIG] = useState({
    CONTRACT_ADDRESS: "0xaddA5a81aFC0f5A006cc411AA6295A3B4f2286a4",
    SCAN_LINK: "https://etherscan.io/address/0xaddA5a81aFC0f5A006cc411AA6295A3B4f2286a4",
    NETWORK: {
      NAME: "Ethereum",
      SYMBOL: "Eth",
      ID: 1,
    },
    NFT_NAME: "Thirst NFT Silver",
    SYMBOL: "TNFTS",
    MAX_SUPPLY: 125,
    ...
    DEEPLINK: "https://metamask.app.link/dapp/thirstnfts.com/MblSilverMint",
  });
  ...
  const getConfig = async () => {
    const configResponse = await fetch("/config/config_silver.json", {
      headers: {
    ...
    <>
      ...
      <div className="container-fluid m-0 banner" id="Home">
        <div className="row h-100 d-inline-block">
          <div className="col-lg-12 banner-text-section">
            <div>
              <h1 className="banner-heading mt-1">Silver Thirst NFTs</h1>
              ...
              {Number(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
                <>
                  ...
                  <div className="banner-counter-button">
                    <div>
          ...
          <div className="d-flex justify-content-center banner-counter-button">
            <CrossmintPayButton
                collectionTitle="Thirst NFT Silver"
                ...
                clientId="9ea347fb-1179-4e74-8146-2fac23a99455"
                mintConfig={{"type":"erc-721","totalPrice":"0.50","_mintAmount":"1"}}
