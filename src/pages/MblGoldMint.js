...
function MblGoldMint() {
  ...
  const [CONFIG, SET_CONFIG] = useState({
    CONTRACT_ADDRESS: "0xB37C8ae34EE36396A839a8E50935AEB1daA110D7",
    SCAN_LINK: "https://etherscan.io/address/0xB37C8ae34EE36396A839a8E50935AEB1daA110D7",
    NETWORK: {
      NAME: "Ethereum",
      SYMBOL: "Eth",
      ID: 1,
    },
    NFT_NAME: "Thirst NFT Gold",
    SYMBOL: "TNFTG",
    MAX_SUPPLY: 125,
    WEI_COST: 650000000000000000,
    DISPLAY_COST: 0.65,
    GAS_LIMIT: 285000,
    MARKETPLACE: "Opeansea",
    MARKETPLACE_LINK: "",
    SHOW_BACKGROUND: false,
    DEEPLINK: "https://metamask.app.link/dapp/thirstnfts.com/MblGoldMint",
  });
      ...
      <div className="container-fluid m-0 banner" id="Home">
        <div className="row h-100 d-inline-block">
          <div className="col-lg-12 banner-text-section">
            <div>
              <h1 className="banner-heading mt-1">Gold Thirst NFTs</h1>
          ...
          <div className="d-flex justify-content-center banner-counter-button">
            <CrossmintPayButton
                collectionTitle="Thirst NFT Gold"
                ...
                clientId="360316b0-603e-4164-9a46-fbb83faf7a35"
